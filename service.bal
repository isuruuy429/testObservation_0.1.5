...
service / on new http:Listener(9090) {
    ...
    resource isolated function get fhir/r4/Observation(http:RequestContext ctx, http:Request request) returns json|xml|r4:FHIRError {
    ...
    resource isolated function get fhir/r4/Observation/[string id](http:RequestContext ctx) returns json|xml|r4:FHIRError {
        ...
        r4:Observation example = {
            ...
            effectiveTiming: {
                event: ["2015-02-07T13:28:17-05:00"],
                repeat: {
                    count: 1,
                    countMax: 10,
                    duration: -23,
    ...
    resource isolated function post fhir/r4/Observation(http:RequestContext ctx, http:Request request) returns json|r4:FHIRError {
